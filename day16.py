...
def generate_data(initial_data, desired_length):
    #     Call the data you have at this point "a".
    a = initial_data
    
    while len(a) < desired_length:
        #     Make a copy of "a"; call this copy "b".
        b = a[:]
        #     Reverse the order of the characters in "b".
        b = b[::-1]
...
with io.open('inputs/day16.txt') as f:
    puzzle_input = f.readlines()[0].strip()
    data = generate_data(puzzle_input, 272)
    print('Checksum for data {} is: {}'.format(puzzle_input, checksum(data[0:272])))
...
with io.open('inputs/day16.txt') as f:
    puzzle_input = f.readlines()[0].strip()
    data = generate_data(puzzle_input, 35651584)
    print('Checksum for data {} is: {}'.format(puzzle_input, checksum(data[0:35651584])))
